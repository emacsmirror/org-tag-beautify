...
(defun org-tag-beautify-set-common-tag-icons ()
  ...
  (setq org-pretty-tags-surrogate-strings
        (append org-pretty-tags-surrogate-strings
                `(("ARCHIVE" . ,(all-the-icons-faicon "archive" :face '(:foreground "gray")))
                  ("export" . ,(all-the-icons-faicon "share-square" :face '(:foreground "orange")))
                  ("noexport" . ,(all-the-icons-faicon "eye-slash" :face '(:foreground "orange")))
                  ("on" . ,(all-the-icons-faicon "toggle-on" :face '(:foreground "orange")))
                  ("off" . ,(all-the-icons-faicon "toggle-off" :face '(:foreground "orange")))
                  ("deprecated" . ,(all-the-icons-faicon "strikethrough" :face '(:foreground "sienna")))
                  ("block" . ,(all-the-icons-material "block" :face '(:foreground "red")))
                  ("lock" . ,(all-the-icons-faicon "lock" :face '(:foreground "red")))
                  ("unlock" . ,(all-the-icons-faicon "unlock" :face '(:foreground "LightGreen")))
                  ("key" . ,(all-the-icons-faicon "key" :face '(:foreground "ForestGreen")))
                  ...
                  ("suggested" . ,(all-the-icons-faicon "star" :face '(:foreground "yellow")))
                  ...
                  ("notify" . ,(all-the-icons-faicon "bell-o" :face '(:foreground "CornflowerBlue")))
                  ("notification" . ,(all-the-icons-faicon "bell" :face '(:foreground "CornflowerBlue")))
                  ("alarm" . ,(all-the-icons-material "alarm" :face '(:foreground "CornflowerBlue")))
                  ("LOG" . ,(all-the-icons-faicon "sticky-note-o" :face '(:foreground "tomato")))
                  ("comment" . ,(all-the-icons-faicon "comments-o" :face '(:foreground "tomato")))
                  ...
                  ("info" . ,(all-the-icons-faicon "info-circle" :face '(:foreground "CornflowerBlue")))
                  ("question" . ,(all-the-icons-faicon "question-circle-o" :face '(:foreground "CornflowerBlue")))
                  ...
                  ("warning" . ,(all-the-icons-faicon "exclamation-triangle" :face '(:foreground "CornflowerBlue")))
                  ("bolt" . ,(all-the-icons-faicon "bolt" :face '(:foreground "CornflowerBlue")))
                  ("bomb" . ,(all-the-icons-faicon "bomb" :face '(:foreground "CornflowerBlue")))
                  ("thunder" . ,(all-the-icons-faicon "bolt" :face '(:foreground "CornflowerBlue")))
                  ("quote" . ,(all-the-icons-faicon "quote-left" :face '(:foreground "CornflowerBlue")))
                  ("history" . ,(all-the-icons-faicon "history" :face '(:foreground "coral")))
                  ("refresh" . ,(all-the-icons-faicon "refresh" :face '(:foreground "gainsboro")))
                  ("repeat" . ,(all-the-icons-faicon "repeat" :face '(:foreground "coral")))
                  ("shuffle" . ,(all-the-icons-material "shuffle" :face '(:foreground "coral")))
                  ("random" . ,(all-the-icons-faicon "random" :face '(:foreground "coral")))
                  ("star" . ,(all-the-icons-faicon "star-o" :face '(:foreground "coral")))
                  ...
                  ("birthday" . ,(all-the-icons-faicon "birthday-cake" :face '(:foreground "khaki")))
                  ("party" . ,(all-the-icons-faicon "beer" :face '(:foreground "khaki")))
                  ...
                  ("credit_card_mastercard" . ,(all-the-icons-faicon "cc-mastercard" :face '(:foreground "CornflowerBlue")))
                  ("credit_card_PayPal" . ,(all-the-icons-faicon "cc-paypal" :face '(:foreground "CornflowerBlue")))
                  ("credit_card_stripe" . ,(all-the-icons-faicon "cc-stripe" :face '(:foreground "CornflowerBlue")))
                  ("credit_card_amex" . ,(all-the-icons-faicon "cc-amex" :face '(:foreground "CornflowerBlue")))
                  ...
                  ("map" . ,(all-the-icons-faicon "map" :face '(:foreground "RosyBrown")))
                  ("map_pin" . ,(all-the-icons-faicon "map-pin" :face '(:foreground "RosyBrown")))
                  ("map_signs" . ,(all-the-icons-faicon "map-signs" :face '(:foreground "RosyBrown")))
                  ("street_view" . ,(all-the-icons-faicon "street-view" :face '(:foreground "RosyBrown")))
                  ("location" . ,(all-the-icons-faicon "map-marker" :face '(:foreground "RosyBrown")))
                  ("location_arrow" . ,(all-the-icons-faicon "location-arrow" :face '(:foreground "RosyBrown")))
                  ...
                  ("rocket" . ,(all-the-icons-faicon "rocket" :face '(:foreground "LightGray")))
                  ...
                  ;; -----------------------------------------------------
                  ;; computer
                  ("clone" . ,(all-the-icons-faicon "clone" :face '(:foreground "LightGray")))
                  ("clipboard" . ,(all-the-icons-faicon "clipboard" :face '(:foreground "LightGray")))
                  ...
                  ("inbox" . ,(all-the-icons-faicon "inbox" :face '(:foreground "DeepSkyBlue")))
                  ("reply" . ,(all-the-icons-faicon "reply" :face '(:foreground "DeepSkyBlue")))
                  ("reply_all" . ,(all-the-icons-faicon "reply-all" :face '(:foreground "DeepSkyBlue")))
                  ("share" . ,(all-the-icons-faicon "share-square-o" :face '(:foreground "DeepSkyBlue")))
                  ...
                  ("rss" . ,(all-the-icons-faicon "rss-square" :face '(:foreground "DeepSkyBlue")))
                  ...
                  ("mute" . ,(all-the-icons-faicon "microphone-slash" :face '(:foreground "DarkSeaGreen")))
                  ("play" . ,(all-the-icons-faicon "play-circle-o" :face '(:foreground "DarkSeaGreen")))
                  ("pause" . ,(all-the-icons-faicon "pause-circle-o" :face '(:foreground "DarkSeaGreen")))
                  ...
                  ("edit" . ,(all-the-icons-faicon "pencil-square" :face '(:foreground "LightSkyBlue")))
                  ("write" . ,(all-the-icons-faicon "pencil" :face '(:foreground "DarkGray")))
                  ("writer" . ,(all-the-icons-faicon "pencil-square-o" :face '(:foreground "LightSkyBlue")))
                  ...
                  ("marketing" . ,(all-the-icons-faicon "bullhorn" :face '(:foreground "LightGreen")))
                  ...
                  ("stock" . ,(all-the-icons-faicon "line-chart" :face '(:foreground "SeaGreen")))
                  ;; philosophy
  ...
  (setq org-pretty-tags-surrogate-strings
        (append org-pretty-tags-surrogate-strings
                `(;; programming
                  ...
                  ("debug" . ,(all-the-icons-faicon "wrench" :face '(:foreground "SteelBlue")))
                  ("troubleshooting" . ,(all-the-icons-faicon "crosshairs" :face '(:foreground "SteelBlue")))
                  ("help" . ,(all-the-icons-faicon "life-ring" :face '(:foreground "SteelBlue")))
                  
                  ;; database
                  ("database" . ,(all-the-icons-faicon "database" :face '(:foreground "CornflowerBlue")))
                  ("schema" . ,(all-the-icons-faicon "th" :face '(:foreground "CornflowerBlue")))
                  ("catalog" . ,(all-the-icons-faicon "th-large" :face '(:foreground "CornflowerBlue")))
                  ("table" . ,(all-the-icons-faicon "table" :face '(:foreground "CornflowerBlue")))
                  ;; ("view" . ,(all-the-icons-faicon "list-alt" :face '(:foreground "CornflowerBlue")))
                  ;; ("index" . ,(all-the-icons-faicon "list-ol" :face '(:foreground "CornflowerBlue")))
                  ("view" . ,(all-the-icons-faicon "th" :face '(:foreground "CornflowerBlue")))
                  ("index" . ,(all-the-icons-faicon "th-list" :face '(:foreground "CornflowerBlue")))
                  ("sort" . ,(all-the-icons-faicon "sort" :face '(:foreground "CornflowerBlue")))

                  ;; computer etc hardware
                  ("computer" . ,(all-the-icons-material "computer" :face '(:foreground "LightSkyBlue")))
                  ("laptop" . ,(all-the-icons-faicon "laptop" :face '(:foreground "LightSkyBlue")))
                  ("tablet" . ,(all-the-icons-faicon "tablet" :face '(:foreground "SkyBlue")))
                  ...
                  ("bluetooth" . ,(all-the-icons-faicon "bluetooth" :face '(:foreground "blue")))
                  ...
                  ("TV" . ,(all-the-icons-faicon "television" :face '(:foreground "SkyBlue")))
                  ...
                  ("cloud_mixed" . ,(all-the-icons-faicon "mixcloud" :face '(:foreground "gray")))
                  ...
                  ("computer_forensic" . ,(all-the-icons-material "important_devices" :face '(:foreground "DodgerBlue")))
                  ...
                  ;; Adobe softwares
                  ("Adobe_Photoshop" . ,(all-the-icons-fileicon "ps" :face '(:foreground "RoyalBlue")))
                  ("Adobe_Premiere" . ,(all-the-icons-fileicon "premiere" :face '(:foreground "DarkMagenta")))
                  ("Adobe_AfterEffect" . ,(all-the-icons-fileicon "ae" :face '(:foreground "DarkViolet")))
                  ("Adobe_Illustrator" . ,(all-the-icons-fileicon "ai" :face '(:foreground "orange")))
                  ("Adobe_InDesign" . ,(all-the-icons-fileicon "id" :face '(:foreground "DarkOrange")))
                  ...
                  ("Apple" . ,(all-the-icons-faicon "apple" :v-adjust -0.05 :face '(:foreground "LightGray")))
                  ("macOS" . ,(all-the-icons-faicon "apple" :v-adjust -0.05 :face '(:foreground "LightGray")))
                  ...
                  ("X10" . ,(all-the-icons-fileicon "x10" :face '(:foreground "gray")))
                  ("X11" . ,(all-the-icons-fileicon "x10" :face '(:foreground "gray")))
                  ...
                  ("Scala" . ,(all-the-icons-alltheicon "scala" :face '(:foreground "DarkBlue")))
                  ...
                  ("Elixir" . ,(all-the-icons-alltheicon "elixir" :face '(:foreground "OrangeRed")))
                  ("Fortran" . ,(all-the-icons-fileicon "fortran" :face '(:foreground "chocolate")))
                  ("Prolog" . ,(all-the-icons-alltheicon "prolog" :face '(:foreground "chocolate")))
                  ("Erlang" . ,(all-the-icons-alltheicon "erlang" :face '(:foreground "chocolate")))
                  ("D" . ,(all-the-icons-alltheicon "dlang" :face '(:foreground "chocolate")))
                  ("J" . ,(all-the-icons-fileicon "j" :face '(:foreground "chocolate")))
                  ("Hy" . ,(all-the-icons-fileicon "hy" :face '(:foreground "chocolate")))
                  ("Coq" . ,(all-the-icons-fileicon "coq" :face '(:foreground "OliveDrab")))
                  ("Ruby" . ,(all-the-icons-alltheicon "ruby-alt" :face '(:foreground "red")))
                  ...
                  ("HTML5" . ,(all-the-icons-faicon "html5" :face '(:foreground "tomato")))
                  ("CSS" . ,(all-the-icons-alltheicon "css3" :face '(:foreground "LightSkyBlue")))
                  ("CSS3" . ,(all-the-icons-faicon "css3" :face '(:foreground "LightSkyBlue")))
                  ("Less" . ,(all-the-icons-alltheicon "less" :face '(:foreground "LightSkyBlue")))
                  ("Sass" . ,(all-the-icons-alltheicon "sass" :face '(:foreground "LightSkyBlue")))
                  ("SVG" . ,(all-the-icons-alltheicon "svg" :face '(:foreground "LightSkyBlue")))
                  ...
                  ("Pascal" . ,(all-the-icons-fileicon "pascal" :face '(:foreground "DarkSlateBlue")))
                  ("Hacklang" . ,(all-the-icons-fileicon "hack" :face '(:foreground "DarkGray")))
                  ("Assembly" . ,(all-the-icons-fileicon "assembly" :face '(:foreground "DarkGray")))
                  ...
                  ("Flask" . ,(all-the-icons-faicon "flask" :face '(:foreground "chocolate")))
  ...
  (setq org-pretty-tags-surrogate-strings
        (append org-pretty-tags-surrogate-strings
                `(("Internet" . ,(all-the-icons-faicon "globe" :face '(:foreground "SkyBlue")))
                  ...
                  ("Yahoo" . ,(all-the-icons-faicon "yahoo" :face '(:foreground "goldenrod")))
                  ...
                  ("LinkedIn" . ,(all-the-icons-faicon "linkedin-square" :face '(:foreground "red")))
