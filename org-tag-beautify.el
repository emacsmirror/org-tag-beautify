  ...
  (setq org-tag-beautify-tag-icons-alist
        (append org-tag-beautify-tag-icons-alist
                `(("ARCHIVE" . ,(nerd-icons-mdicon "nf-md-archive" :face 'nerd-icons-silver))
                  ...
                  ("privacy" . ,(nerd-icons-mdicon "nf-md-folder_hidden" :face 'nerd-icons-purple))
                  ...
                  ("clock" . ,(nerd-icons-mdicon "nf-md-clock_outline" :face 'nerd-icons-blue))
                  ("timer" . ,(nerd-icons-mdicon "nf-md-timer_outline" :face 'nerd-icons-blue))
                  ...
                  ("alert" . ,(nerd-icons-mdicon "nf-md-alert_outline" :face 'nerd-icons-red))
                  ("important" . ,(nerd-icons-faicon "nf-fa-exclamation_circle" :face 'nerd-icons-red))
                  ...
                  ("question" . ,(nerd-icons-mdicon "nf-md-comment_question_outline" :face 'nerd-icons-purple))
                  ("answer" . ,(nerd-icons-mdicon "nf-md-comment_text_outline" :face 'nerd-icons-blue))
                  ("example" . ,(nerd-icons-mdicon "nf-md-information_outline" :face 'nerd-icons-blue))
                  ("error" . ,(nerd-icons-codicon "nf-cod-error" :face 'nerd-icons-red))
                  ("warning" . ,(nerd-icons-faicon "nf-fa-exclamation_triangle" :face 'nerd-icons-red))
                  ("bolt" . ,(nerd-icons-mdicon "nf-md-lightning_bolt" :face 'nerd-icons-yellow))
                  ("bomb" . ,(nerd-icons-mdicon "nf-md-bomb" :face 'nerd-icons-red))
                  ...
                  ("heart" . ,(nerd-icons-mdicon "nf-md-heart_outline" :face 'nerd-icons-red))
                  ("heart_beat" . ,(nerd-icons-mdicon "nf-md-heart_pulse" :face 'nerd-icons-red))
                  ("brain" . ,(nerd-icons-faicon "nf-fae-brain" :face 'nerd-icons-blue))
                  ("mind" . ,(nerd-icons-mdicon "nf-md-brain" :face 'nerd-icons-blue))
                  ...
                  ("screenshot" . ,(nerd-icons-mdicon "nf-md-monitor_screenshot" :face 'nerd-icons-cyan))
                  ...
                  ("gift" . ,(nerd-icons-mdicon "nf-md-gift_outline" :face 'nerd-icons-blue))
                  ...
                  ("meat" . ,(nerd-icons-faicon "nf-fae-meat" :face 'nerd-icons-red))
                  ...
                  ("weekend" . ,(nerd-icons-mdicon "nf-md-calendar_weekend_outline" :face 'nerd-icons-blue))
                  ...
                  ("ETH" . ,(nerd-icons-mdicon "nf-md-ethereum" :face 'nerd-icons-blue))
                  ...
                  ("see_doctor" . ,(nerd-icons-mdicon "nf-md-hospital_box" :face 'nerd-icons-red))
                  ...
                  ("court" . ,(nerd-icons-codicon "nf-cod-law" :face 'nerd-icons-blue))
                  ...
                  ("censorship" . ,(nerd-icons-mdicon "nf-md-monitor_eye" :face 'nerd-icons-red))
                  ...
                  ("OneNote" . ,(nerd-icons-mdicon "nf-md-microsoft_onenote" :face 'nerd-icons-purple))
                  ...
                  ("color" . ,(nerd-icons-faicon "nf-fa-palette" :face 'nerd-icons-red))
                  ("palette" . ,(nerd-icons-faicon "nf-fa-palette" :face 'nerd-icons-red))
                  ...
                  ("link" . ,(nerd-icons-mdicon "nf-md-link_variant" :face 'nerd-icons-cyan))
                  ("at" . ,(nerd-icons-mdicon "nf-md-at" :face 'nerd-icons-cyan))
                  ("mention" . ,(nerd-icons-octicon "nf-oct-mention" :face 'nerd-icons-cyan))
                  ...
                  ("programmer" . ,(nerd-icons-codicon "nf-cod-code" :face 'nerd-icons-blue))
                  ("coder" . ,(nerd-icons-codicon "nf-cod-code" :face 'nerd-icons-blue))
                  ...
                  ("driver" . ,(nerd-icons-mdicon "nf-md-account_tie_hat" :face 'nerd-icons-blue))
...
(defun org-tag-beautify--add-programming-tag-icons ()
  ...
  (setq org-tag-beautify-tag-icons-alist
        (append org-tag-beautify-tag-icons-alist
                `(;; programming
                  ("programming" . ,(nerd-icons-mdicon "nf-md-developer_board" :face 'nerd-icons-blue))
                  ("code" . ,(nerd-icons-codicon "nf-cod-code" :face 'nerd-icons-cyan))
                  ...
                  ("bug" . ,(nerd-icons-codicon "nf-cod-bug" :face 'nerd-icons-red))
                  ...
                  ("coding" . ,(nerd-icons-faicon "nf-fa-keyboard_o" :face 'nerd-icons-cyan))
                  ...
                  ("regex" . ,(nerd-icons-codicon "nf-cod-regex" :face 'nerd-icons-cyan))
                  ("regexp" . ,(nerd-icons-codicon "nf-cod-regex" :face 'nerd-icons-cyan))
                  ...
                  ("troubleshooting" . ,(nerd-icons-faicon "nf-fa-crosshairs" :face 'nerd-icons-blue))
                  ("help" . ,(nerd-icons-mdicon "nf-md-help_circle_outline" :face 'nerd-icons-blue))
                  ...
                  ("database_sort" . ,(nerd-icons-mdicon "nf-md-sort_bool_ascending_variant" :face 'nerd-icons-blue))
                  ...
                  ("Raspberry_Pi" . ,(nerd-icons-flicon "nf-linux-raspberry_pi" :face 'nerd-icons-red))
                  ...
                  ("IPv6" . ,(nerd-icons-mdicon "nf-md-ip_network" :face 'nerd-icons-red))
                  ...
                  ("Chromium" . ,(nerd-icons-faicon "nf-fa-chrome" :face 'nerd-icons-blue))
                  ...
                  ("FreeDesktop" . ,(nerd-icons-flicon "nf-linux-freedesktop" :face 'nerd-icons-blue))
                  ...
                  ("Xfce" . ,(nerd-icons-flicon "nf-linux-xfce" :face 'nerd-icons-blue))
                  ...
                  ("cracker" . ,(nerd-icons-faicon "nf-fa-user_secret" :face 'nerd-icons-red))
                  ...
                  ("Gentoo_Linux"   . ,(nerd-icons-flicon "nf-linux-gentoo" :face 'nerd-icons-blue))
                  ...
                  ("Deepin_Linux"   . ,(nerd-icons-flicon "nf-linux-deepin" :face 'nerd-icons-blue))
                  ("OpenSUSE_Linux" . ,(nerd-icons-flicon "nf-linux-opensuse" :face 'nerd-icons-green))
                  ;; ("OpenSUSE_Linux" . ,(nerd-icons-faicon "nf-fa-suse" :face 'nerd-icons-green))
                  ...
                  ("app_store_ios" . ,(nerd-icons-faicon "nf-fa-app_store_ios" :face 'nerd-icons-blue))
                  ...
                  ("Ruby" . ,(nerd-icons-mdicon "nf-md-language_ruby" :face 'nerd-icons-red))
                  ...
                  ("wasm" . ,(nerd-icons-sucicon "nf-seti-wasm" :face 'nerd-icons-blue))
                  ...
                  ;; Development
                  ("API" . ,(nerd-icons-mdicon "nf-md-api" :face 'nerd-icons-orange))
                  ...
                  ("GraphQL" . ,(nerd-icons-mdicon "nf-md-graphql" :face 'nerd-icons-red))
                  ("Flask" . ,(nerd-icons-mdicon "nf-md-flask" :face 'nerd-icons-blue))
                  ("webpack" . ,(nerd-icons-mdicon "nf-md-webpack" :face 'nerd-icons-blue))
                  ("React" . ,(nerd-icons-devicon "nf-dev-react" :face 'nerd-icons-blue))
                  ...
                  ("Visual_Studio_Code" . ,(nerd-icons-mdicon "nf-md-microsoft_visual_studio_code" :face 'nerd-icons-blue))
                  ...
                  ("Makefile" . ,(nerd-icons-sucicon "nf-seti-makefile" :face 'nerd-icons-orange))
  ...
  (setq org-tag-beautify-tag-icons-alist
        (append org-tag-beautify-tag-icons-alist
                `(("Internet" . ,(nerd-icons-codicon "nf-cod-globe" :face 'nerd-icons-blue))
                  ...
                  ("Microsoft" . ,(nerd-icons-mdicon "nf-md-microsoft" :face 'nerd-icons-blue))
                  ...
                  ("Twitter" . ,(nerd-icons-mdicon "nf-md-twitter" :face 'nerd-icons-blue))
                  ...
                  ("YouTube" . ,(nerd-icons-mdicon "nf-md-youtube" :face 'nerd-icons-red))
                  ...
                  ("Dropbox" . ,(nerd-icons-mdicon "nf-md-dropbox" :face 'nerd-icons-blue))
