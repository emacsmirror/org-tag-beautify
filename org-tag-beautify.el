  ...
  (setq org-tag-beautify-tag-icons-alist
        (append org-tag-beautify-tag-icons-alist
                `(("ARCHIVE" . ,(nerd-icons-mdicon "nf-md-archive" :face 'nerd-icons-silver))
                  ...
                  ("brain" . ,(nerd-icons-faicon "nf-fae-brain" :face 'nerd-icons-lblue))
                  ...
                  ("court" . ,(nerd-icons-codicon "nf-cod-law" :face 'nerd-icons-yellow))
  ...
  (setq org-tag-beautify-tag-icons-alist
        (append org-tag-beautify-tag-icons-alist
                `(;; programming
                  ...
                  ;; ("OpenSUSE_Linux" . ,(nerd-icons-faicon "nf-fa-suse" :face 'nerd-icons-lgreen))
                  ...
                  ("wasm" . ,(nerd-icons-sucicon "nf-seti-wasm" :face 'nerd-icons-lblue))
