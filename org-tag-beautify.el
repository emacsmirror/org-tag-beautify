  ...
  (setq org-pretty-tags-surrogate-strings
        (append org-pretty-tags-surrogate-strings
                `(("programming" . ,(all-the-icons-material "developer_board" :face '(:foreground "LightSlateBlue")))
                  ...
                  ("view" . ,(all-the-icons-faicon "th-list" :face '(:foreground "CornflowerBlue")))
                  ...
                  ;; ("debug" . ,(all-the-icons-faicon "" :face '(:foreground "SteelBlue")))
                  ...
                  ;; TODO ("hacker" . ,(all-the-icons-faicon "" :face '(:foreground "DimGray")))
